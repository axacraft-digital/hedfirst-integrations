      ...
      <DialogContent className='sm:max-w-[500px]'>
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new webhook scenario for Slack alerts. You'll need to create the corresponding Slack channel and incoming webhook first.
            </DialogDescription>
          </DialogHeader>
          <div className='grid gap-4 py-4'>
            ...
            <div className='grid gap-2'>
              ...
              <p className='text-muted-foreground text-xs'>
                Leave blank to configure later. You can get this URL from your Slack workspace's incoming webhooks settings.
              </p>
            </div>
          </div>
          <DialogFooter>
